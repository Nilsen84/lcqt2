(function (lcqtDirectory) {
    ...
    remote.getCurrentWindow().webContents.removeAllListeners('devtools-opened')
    ...
    waitForElement("#exit-button").then(exitButton => {
        ...
        clone.addEventListener('click', () => {
            const modalWin = new remote.BrowserWindow({
            ...
            //modalWin.loadURL('http://127.0.0.1:5173')
            modalWin.loadURL(`file://${lcqtDirectory}/gui.asar/index.html`)
        })
